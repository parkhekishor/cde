...
public class InConsistencyInGraphException extends Exception {
	...
	public InConsistencyInGraphException(String message, Throwable throwable) {		
	...
	public InConsistencyInGraphException(Throwable throwable) {
		
		super(throwable);
		this.throwable = throwable;
	}

	public InConsistencyInGraphException(String message) {
		super(message);
		this.message = message;
	}
